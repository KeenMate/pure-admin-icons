...
defmodule Database.Processors.GetIconDetailProcessor do
  ...
  def parse_result_row([icon_id, icon_set_code, icon_set_title, name, style_code, style_color_method, sizes, has_single_source, is_scalable, filenames, platform_identifiers, categories, phrases]) do
