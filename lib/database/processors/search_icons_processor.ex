...
defmodule Database.Processors.SearchIconsProcessor do
  ...
  def parse_result_row([rank, similarity, exact_match, synonym_exact_match, icon_id, icon_set_code, icon_set_title, name, style_code, style_color_method, sizes, has_single_source, is_scalable, filenames, platform_identifiers, categories, total_items]) do
    {:ok, %SearchIconsModel{
      rank: rank,
      similarity: similarity,
      exact_match: exact_match,
      synonym_exact_match: synonym_exact_match,
      icon_id: icon_id,
