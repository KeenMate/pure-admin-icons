          ...
          <div>
            ...
            <div class="space-y-4 text-sm">
              <div class="border-b border-base-300/30 pb-4">
                ...
                <p class="text-base-content/85">Search icons by name. Filter by style and size. Returns icon names, styles, sizes, and SVG URLs.</p>
              </div>
              <div class="border-b border-base-300/30 pb-4">
                <div class="flex items-center gap-3 mb-2">
                  <code class="text-primary font-mono">get_icon_svg</code>
                </div>
                <p class="text-base-content/85">Fetch the raw SVG content of a specific icon. Useful for embedding icons directly.</p>
              </div>
            </div>
          </div>
